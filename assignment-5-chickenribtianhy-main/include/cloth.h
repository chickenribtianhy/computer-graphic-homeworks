...
public:
  ...
  void set_intersect_obj(const std::shared_ptr<Object> obj);
  bool is_intersect_obj_sphere(Vec3 position) const;
  Vec3 ComputeFluidForce(int iw, int ih, Vec3 vertex_velocity) const;
  ...
  Vec3 intersect_obj_pos;
  Float intersect_obj_radius;
